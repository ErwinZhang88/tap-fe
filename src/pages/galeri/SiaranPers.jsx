...
class SiaranPers extends Component{
                ...
                <div className="col col-lg-12 col-md-12 col-sm-12 col-xs-12 box-desc bg-clr-white-1">
                    <div className="row">
                        <div className="col col-lg-9 col-md-9 col-sm-12 col-xs-12">
                            <h2 className="txt-uppercase">Siaran Pers</h2>
                            <div className="row list-berita">
                                ...
                                <div className="col col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    ...
                                    <label className="label-medium-bold csr-pointer">Industri Sawit Ikut Perangi Corona</label>
                                </div>
                            </div>
                            <div className="row list-berita">
                                <div className="col col-lg-2 col-md-2 col-sm-2 col-xs-2">
