            ...
            <div className="row box-content">
                ...
                <div className="col col-lg-12 col-md-12 col-sm-12 col-xs-12 box-desc bg-clr-white-1">
                    ...
                    <div className="col col-lg-9 col-md-9 col-sm-12 col-xs-12">
                            <h2 className="txt-uppercase">Buletin</h2>
                                
                            <div className="row m-b-35">
                                <div className="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div className="box-filedownload-thumb">
                                        <img className="cover" src="/assets/img/galeri/buletin/sustainability_news_1.png" />
                                        <div className="desc-info">
                                            <img className="icon" src="/assets/img/pdf_icon.png" />
                                            <label className="label-small-regular">Buletin 2016</label>
                                        </div>
                                ...
                                <div className="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div className="box-filedownload-thumb">
                                        <img className="cover" src="/assets/img/galeri/buletin/sustainability_news_2.png" />
                                        <div className="desc-info">
                                            <img className="icon" src="/assets/img/pdf_icon.png" />
                                            <label className="label-small-regular">Buletin 2019</label>
                                        </div>
                                        <button className="btn-4 txt-clr-white-1">Download <FontAwesomeIcon icon="arrow-down" className="icon" /></button>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                <div className="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div className="box-filedownload-thumb">
                                        <img className="cover" src="/assets/img/galeri/buletin/sustainability_news_3.png" />
                                        <div className="desc-info">
                                            <img className="icon" src="/assets/img/pdf_icon.png" />
                                            <label className="label-small-regular">Buletin 2020</label>
                                        </div>
                                        <button className="btn-4 txt-clr-white-1">Download <FontAwesomeIcon icon="arrow-down" className="icon" /></button>
                                    </div>
                                </div>
                                ...
                                <div className="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div className="box-filedownload-thumb">
                                        <img className="cover" src="/assets/img/galeri/buletin/sustainability_news_4.png" />
                                        <div className="desc-info">
                                            <img className="icon" src="/assets/img/pdf_icon.png" />
                                            <label className="label-small-regular">Buletin 2020</label>
                                        </div>
